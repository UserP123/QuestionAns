...
function getView($data5)
{
    echo '<div class="VIEW_MODAL top-0 fixed  hidden absolute w-screen h-screen flex items-center justify-center bg-black" >

<div class="relative w-1/2  h-10/12  bg-white rounded-lg shadow dark:bg-gray-700">
    ...
    <div class="p-6 space-y-6">
        ...
        while($answer =mysqli_fetch_assoc($data5))
    {
